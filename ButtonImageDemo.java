...
public class ButtonImageDemo extends Application {
	...
	public void start(Stage myStage) {
		...
		Button btnHourglass = new Button("Hourglass", new ImageView("E:\\workspace\\JavaFXSkel\\src\\application\\hourglass.jpg"));
		Button btnAnalogClock = new Button("Analog Clock", new ImageView("E:\\workspace\\JavaFXSkel\\src\\application\\analogclock.png"));
